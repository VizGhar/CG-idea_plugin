...
class CgBuildSystemMavenStep(parentStep: NewProjectWizardStep) : AbstractNewProjectWizardStep(parentStep) {

    override fun setupProject(project: Project) {
        GeneratorContext.buildSystem = GENERATOR_BUILD_SYSTEM_MAVEN
    }
}