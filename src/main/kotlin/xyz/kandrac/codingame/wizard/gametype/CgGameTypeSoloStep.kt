...
import xyz.kandrac.codingame.wizard.GENERATOR_TYPE_SOLO
import xyz.kandrac.codingame.wizard.GeneratorContext

class CgGameTypeSoloStep(parentStep: NewProjectWizardStep) : AbstractNewProjectWizardStep(parentStep) {

    override fun setupProject(project: Project) {
        GeneratorContext.gameType = GENERATOR_TYPE_SOLO
